...
<head>
	...
	<script>
		...
		{
			return confirm("Etes-vous sur de vouloir supprimer l'utilisateur ?");
		}
	</script>
</head>
<body>
		...
		<div id="content">
			...
			<h2>Gestion des utilisateurs</h2>
				<form action="../modif.php" method="post">
					...
					<input onclick="return confirm_del()" type="submit" name="delete_user" value="Supprimer l'utilisateur">
				</form>
			</div>
		</div>
	</div>
